...
* [Salesforce Success Plans](https://trailhead.salesforce.com/content/learn/modules/premier-success-plans?trail_id=achieve-your-goals-with-success-cloud)
  ...
  1. [Get to Know Salesforce Success Plans](https://trailhead.salesforce.com/content/learn/modules/premier-success-plans/get-started-with-your-premier-success-plan?trail_id=achieve-your-goals-with-success-cloud)
     ...
     * Description of Salesforce Success Plans (Standard Success Plan, Premier Success Plan, Signature Success Plan),
     * Benefits you gain with each plan.
  ...
  2. [Discover the Premier Success Plan](https://trailhead.salesforce.com/content/learn/modules/premier-success-plans/resolve-issues-fast-with-premier-support?trail_id=achieve-your-goals-with-success-cloud)
     ...
     * Enhanced description of Premier Success Plan,
     * Expert guidance and best practices (onboarding, Success Path & Success Reviews, individual expert coaching sessions, always-on technical support, Developer Support, training discounts),
     * Four severity levels of business-stopping issues that Success Plans like Premier address.
  ...
  3. [Explore the Signature Success Plan](https://trailhead.salesforce.com/content/learn/modules/premier-success-plans/learn-about-success-managers-accelerators-and-admin-assist?trail_id=achieve-your-goals-with-success-cloud)
     ...
     * Enhanced description of Signature Success Plan,
     * Key Signature features (proactive, personalized partnership, Customer Success Manager, Success Path and Success Reviews, Customer Success Score, virtual Instructor-Led classes, Annual technical health reviews, specialized architect reviews, proactive monitoring 24/7, Key Event Management, guidance on performance optimization and go-lives, expedited issue resolution).
